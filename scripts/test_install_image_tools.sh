...
monitor_workflow=$root/.github/workflows/monitor.yaml
...
grep -Fx '  GRYPE_VERSION: 0.116.1' "$build_workflow" "$monitor_workflow"
grep -Fx '  GRYPE_SHA256: 0122df7b655981abe547ad3d2190d65551dac6a2bfc80b4dc2a989b5d0587458' "$build_workflow" "$monitor_workflow"
